...
<input type="radio" name="tabs" id="tab1"/> 
  <label for="tab1"><h3>The Learning Feed</h3></label>
    <div class="tab content1">
      <p>This site is a continuous feed of interesting ideas about learning, expertise, education and instruction. I created it to scratch my own itch -- I desperately wanted a place to visit that was full of stimulating thoughts about learning. Following people on social media is great but there are very few people who <em>only</em> post about learning. I wanted a way to cut through the noise so I made The Learning Feed. Visit the site: <a href="https://thelearningfeed.com" target="_blank" rel="noref">TheLearningFeed.com</a></p>
